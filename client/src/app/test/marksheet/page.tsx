...
const MarkList = () => {
	const [data, setData] = useState([
		...
		{ id: 4, name: "Cy Ganderton", rollNo: "23", marks: "234", isChecked: true },
		{ id: 5, name: "Hart Hagerty", rollNo: "23", marks: "123", isChecked: false },
		{ id: 6, name: "Brice Swyre", rollNo: "23", marks: "432", isChecked: true },
		{ id: 7, name: "Cy Ganderton", rollNo: "23", marks: "234", isChecked: true },
		{ id: 8, name: "Hart Hagerty", rollNo: "23", marks: "123", isChecked: false },
	...
	return (
		<>
			...
			<main className="h-full w-full p-10">
				...
				<button className="btn btn-primary mt-20 justify-center">Export Marksheet</button>
			</main>
		</>
	);
};
